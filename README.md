...
## 웹 페이지 미리보기
- 레포지토리 루트의 `index.html`을 GitHub 웹 뷰어나 정적 호스팅(예: GitHub Pages)으로 열면 효율적 투자선 이미지를 포함한 요약 웹사이트를 확인할 수 있습니다.
- 스타일은 `styles.css`에 정의되어 있으며, 기존 분석 산출물(`README.md`, `REPORT.md`, `assets/efficient_frontier.svg`)과 연동됩니다.
